    ...
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="p-5">
        ...
        <div className='flex sm:flex-row flex-col justify-center items-center gap-4'>
          <a href="https://github.com/mhmddorgham" className=' inline-flex  py-2 px-3 bg-blue-gradient font-poppins font-medium text-[15px] text-primary outline-none mt-10 rounded-xl'>
            Source
